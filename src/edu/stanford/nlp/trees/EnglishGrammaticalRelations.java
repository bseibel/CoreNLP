...
public class EnglishGrammaticalRelations {
  ...
  */ // mihai: end block
    ...
    private static final Map<String, GrammaticalRelation> preps = new MapMaker().concurrencyLevel(32).makeMap();
    private static final Map<String, GrammaticalRelation> prepsC = new MapMaker().concurrencyLevel(32).makeMap();
    ...
    public static GrammaticalRelation getPrep(String prepositionString) {
        ...
        return preps.get(prepositionString);
    }
    ...
    public static GrammaticalRelation getPrepC(String prepositionString) {
        ...
        return prepsC.get(prepositionString);
    }
